package com.lwn.common.utils.util.QRCode;
...
public class QRCodeUtil {
    ...
    /**
     * @param content      扫描二维码出现的内容
     * @param imgPath      二维码嵌入的图片位置
    ...
    /**
     * @param content      扫描二维码出现的内容
     * @param imgPath      二维码可嵌入的图片位置
     * @param destPath     生成二维码的位置
     * @param needCompress 是否需要压缩
     * @throws Exception
     */
     ...
     * @param destPath
     * @throws Exception
     * @description 生成有图片嵌入但不压缩的纯二维码  等同于 {@link com.lwn.common.utils.util.QRCode.QRCodeUtil#encode(java.lang.String, java.lang.String)}
     */
